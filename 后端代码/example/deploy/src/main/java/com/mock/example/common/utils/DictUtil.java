...
import com.mock.example.common.component.cache.DictCache;
...
public class DictUtil {
    ...
    public static void setDictCache(String key, List<SysDictData> dictDatas) {
        SpringUtil.getBean(DictCache.class).setCache(key, dictDatas);
    }
    ...
    public static List<SysDictData> getDictCache(String key) {
        Object cacheObj = SpringUtil.getBean(DictCache.class).getCache(key);
    ...
    public static void removeDictCache(String key) {
        SpringUtil.getBean(DictCache.class).removeCache(key);
    }
    ...
    public static void clearDictCache() {
        SpringUtil.getBean(DictCache.class).removeAllCache();
    }
