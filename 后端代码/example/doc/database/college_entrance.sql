...
CREATE TABLE `ce_aspiration_detail` (
                                        ...
                                        `profession_sort` int NOT NULL COMMENT '志愿专业顺序',
                                        `created_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
                                        `created_user` varchar(16)  NOT NULL DEFAULT '' COMMENT '创建人',
                                        `updated_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
                                        `updated_user` varchar(16)  DEFAULT NULL COMMENT '修改人',
                                        PRIMARY KEY (`id`)
) ENGINE=InnoDB  COMMENT='志愿明细';
...
-- ----------------------------
BEGIN;
INSERT INTO `ce_student` VALUES (19, 42, 'A2020001', '张三', 2020, 2023, 'WOMEN', 510, '2023-04-02 15:46:33', 'admin', '2023-04-02 18:15:30', 'admin');
...
INSERT INTO `sys_role` VALUES (11, '学生角色', 'student', 30, '1', 1, 1, '0', '0', 'admin', '2023-04-02 03:40:36', 'admin', '2023-04-05 03:13:41', NULL);
COMMIT;
